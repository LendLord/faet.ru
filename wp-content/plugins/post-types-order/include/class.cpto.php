                    ...
                    foreach( $post_types as $post_type_name ) 
                        {
                            ...
                            if ($post_type_name == 'post')
                                add_submenu_page('edit.php', 'Изменить порядок', 'Изменить порядок', $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                            elseif ($post_type_name == 'attachment') 
                                add_submenu_page('upload.php', 'Изменить порядок', 'Изменить порядок', $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') ); 
                            else
                                {
                                    add_submenu_page('edit.php?post_type='.$post_type_name, 'Изменить порядок', 'Изменить порядок', $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );    
                                }
                        }
                }
            ...
            function SortPage() 
                {
                    ...
                    <div id="cpto" class="wrap">
                        ...
                        <h2><?php echo $this->current_post_type->labels->singular_name . ' -  '. 'Изменить порядок' ?></h2>
                        ...
                        <p class="submit">
                            <a href="javascript: void(0)" id="save-order" class="button-primary">Обновить</a>
                        </p>
